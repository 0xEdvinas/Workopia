        ...
        <div class="rounded-lg shadow-md bg-white">
          <div class="p-4">
            ...
            <ul class="my-4 bg-gray-100 p-4 rounded">
              <li class="mb-2"><strong>Salary:</strong> <?php echo formatSalary($listing->salary); ?></li>
              <li class="mb-2">
                <strong>Location:</strong> <?php echo $listing->city . ', ' . $listing->state; ?>
                <!-- <span
                  class="text-xs bg-blue-500 text-white rounded-full px-2 py-1 ml-2">Remote</span> -->
              </li>
              <?php if (!isset($listing->tags)) : ?>
                <li class="mb-2">
                  <strong>Tags:</strong> <span><?php echo $listing->tags; ?></span>,
                </li>
              <? endif; ?>
            </ul>
